...
public:
	...
	bool AddFile(LPCTSTR szFileName, DWORD dwFlags = 0);
	BOOL WriteToFile(LPCTSTR szFileName, DWORD dwFlags = MEMBUFFER_FLAG_WRITEFILE_OVERWRITE);
	BOOL WriteToFile(std::wstring &sFileName, DWORD dwFlags = MEMBUFFER_FLAG_WRITEFILE_OVERWRITE);
	BOOL WriteToFile(std::wstringstream &ssFileName, DWORD dwFlags = MEMBUFFER_FLAG_WRITEFILE_OVERWRITE);
#else

...
public:
	...
	BOOL SetImage(LPCTSTR pszFile,COLORREF clrBkgnd,BOOL bAutoSize=TRUE,BOOL bNormalDisable=TRUE);
	BOOL SetImage(LPCTSTR pszFile,LPCSTR pszToolTip,COLORREF clrBkgnd,BOOL bAutoSize=TRUE,BOOL bNormalDisable=TRUE);
...
private:
	...
	void P_Draw3dRect(HDC dc, const CRect&rc, CPen&penTL, CPen&penBR);
	void P_InitButton();
